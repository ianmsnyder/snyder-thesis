...
\caption{An illustration of the pMSSM as a subset of the larger MSSM, both under the larger umbrella of SUSY theories.}% with one SUSY transformation, N=1.} 
\label{fig:pmssm}
\end{figure}
%
