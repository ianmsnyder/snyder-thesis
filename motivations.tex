...
Supersymmetry (SUSY)\cite{Borschensky:2014cia, Golfand:1971iw,, Volkov:1973ix, Wess:1974tw, Salam:1974ig} is an extension of the SM: in SUSY there is a boson partner to each fermion in the SM and vice-versa.  This means that there is a scalar partner to the top quark, called the stop quark ($\tilde{t}$)\footnote{Just as there are left- and right-handed quarks in the SM, there are left- and right-handed SUSY partners, $\tilde{t}_L$ and $\tilde{t}_R$ respectively.  These mix to form stop eigenstates, the lightest being $\tilde{t}_1$ and the heavier $\tilde{t}_2$.  The lighter $\tilde{t}_1$ is referred to as the $\tilde{t}$.} that cancels the large correction from the top quark.  The naming conventions for the SUSY particles is described in section \ref{sec:PartCont}.  There are similar partners for the other quarks.  \\
...
\begin{figure}[tbh]
	...
	\caption{Renormalization group evolution of inverse gauge couplings in the Standard Model (dashed) and with a SUSY theory (solid) with varying SUSY particle mass thresholds and couplings.  The SM couplings do not unify at any point while the MSSM couplings nearly unify at an energy scale of $10^{16}$ GeV \cite{susyprimer}.} }
...
\centering
	\begin{tikzpicture}
        ...
        \node[align=center,blue,font={\scriptsize\bfseries}] at (2.,4.5) {Subgroup};%N=1};
...
\caption{An illustration of the pMSSM as a subgroup of the larger MSSM, both under the larger umbrella of SUSY theories.}% with one SUSY transformation, N=1.} 
\label{fig:pmssm}
\end{figure}
%
